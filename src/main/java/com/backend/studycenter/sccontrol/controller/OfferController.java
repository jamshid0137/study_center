...
import com.backend.studycenter.events.EmailEvent;
import com.backend.studycenter.events.EmailPublisher;
...
public class OfferController {
   ...
   // @Autowired
    ...
    public ResponseEntity<OfferDTO> save(@RequestBody OfferDTO offerDTO) {
        try {
           // emailPublisher.publishEmailEvent(new EmailEvent("jmadaminov.unlimited@gmail.com", "Muaffaqiyatlimi","Muaffaqiyatli test"));
